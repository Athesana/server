...
<body>
	...
	<!-- include한 페이지(includePage.jsp)에서 scriptlet으로 선언된 변수를 그대로 사용할 수 있다. -->
	...
	<!-- 서블릿이 각각 만들어지기 때문에 변수가 중복되어도 상관없다. 컴파일 될 때 서블릿 안에 삽입되는게 아니라, 실행할 때 제어권이 잠시 넘어갔다가 원래 페이지로 돌아오는 형식 -->
	
	<!-- 액션 태그에서 변수는 페이지 간에 공유되지 않기 때문에 jsp:param 액션 태그를 이용해서 포함되는 페이지로 값을 전달할 수 있다. -->
	<jsp:include page="includePage.jsp">
